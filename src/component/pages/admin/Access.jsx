            ...
            <div className=' pt-5s mt-5 rounded-lg justify-between items-center flex w-full dark:!bg-navy-800 dark:text-white'>
                <div className="relative ml-10 mb-10 mt-5 overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <table className="w-full text-sm text-left rtl:text-right text-gray-700 dark:text-gray-300">
                        ...
                        <tbody>
                            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-300 hover:text-white hover:bg-gray-50 dark:hover:bg-gray-900">
                                ...
                                <th scope="row" className="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                    <Avatar />
                                    <div className="ps-3">
                                        <div className="text-base font-semibold">Bùi Xuân Mạnh</div>
                                        <div className="font-normal text-gray-500">bmanh7920@gmail.com</div>
                                    </div>
                                </th>
                                <td className="px-6 py-4">
                                    20/01/2024
                                ...
                                <td className="w-4 p-4">
                                    <div className="flex items-center">
                                        <input id="checkbox-table-search-1" checked type="checkbox" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                ...
                                <td className="px-6 py-4 ">
                                    <div className='flex items-center justify-center'>
                                        ...
                                        {!showAvtive ? <div onClick={() => handleRemove()} className="font-medium ml-2 flex items-center text-red-600 dark:text-red-500 hover:underline cursor-pointer">
                                            <AiOutlineSelect />
                                            <div className='ml-1'>Remove</div>
                                        </div> : <div onClick={() => handleActive()} className="font-medium ml-2 flex items-center text-green-600 dark:text-green-500 hover:underline cursor-pointer">
                                            <AiOutlineSelect />
