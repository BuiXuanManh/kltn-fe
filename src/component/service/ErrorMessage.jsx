export default class ErrorMessage {
    constructor() {
        this.error = {
            ...
            cppasswordRequired: "Xác nhận mật khẩu không được để trống",
            ...
            firstName: "Họ đệm phải ít nhất 2 chữ trở lên",
            lastName: "Tên phải ít nhất 2 chữ trở lên",
            firstNameRequired: "Họ đệm không được để trống",
            lastNameRequired: "Tên không được để trống",
